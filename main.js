...
G.Launch=function()
{
	...
	G.Init=function()
	{
		...
		G.iconScale=1;
		G.iconURL='img/iconSheet.png';
		if (G.isIE)
		{
			var img=Pic('img/iconSheet.png');
	...
	G.NewGame=function(doneLoading,mods)
	{
		...
		G.dialogue.popup(function(div){
			...
			'<div class="framed bgMid fancyText" style="position:absolute;left:-2px;bottom:-26px;">'+G.textWithTooltip('<x style="color:red;font-size:200%;">NOTE FROM OWEN</x>','<div style="width:240px;text-align:left;padding:4px;"><div class="par">Daddy Orteil says "No rehosting", but I want it to be known: this game would be unavailable to students of DHS without this rip. If you can access it, PLEASE use the original site!!!</div><div class="par">Also, I added a hotkey for fast-forward toggling (CTRL+SPACE). I thought it might be useful :). If you want any other QOL features, let me know!</div><div class="par">Also, saving doesn\'t work. Manually save as text instead!</div></div>')+'</div>'+
...
window.onload=function()
{
	if (!G.ready)
	{
		...
		else
		{
			...
			script.setAttribute('src','./metaLegacy.js');//we add a random bit to the URL to prevent caching
																										// not anymore, toe man!
